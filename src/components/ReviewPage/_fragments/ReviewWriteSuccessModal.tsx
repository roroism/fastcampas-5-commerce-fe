...
interface ReviewWriteSuccessModalProps extends Omit<ModalProps, 'children'> {
  title: string;
}
function ReviewWriteSuccessModal({
  isOpen,
  onClose,
  ...props
}: ReviewWriteSuccessModalProps) {
...
export default ReviewWriteSuccessModal;
